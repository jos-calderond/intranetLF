...
Public Class WebService
  ...
  ''' <summary>
  ''' 15/07/2019 creacion:jcadleron
  ''' </summary>
  ''' <param name="ORQ"></param>
  ''' <param name="FECHA_DMSA"></param>
  ''' <param name="RUTFUN"></param>
  ''' <param name="VAMENU"></param>
  ''' <returns></returns>
  ''' <remarks></remarks>
  <WebMethod()> _
  Public Function WCADM(ByVal ORQ As String,
                                               ByVal FECHA_DMSA As String,
    ...
    Try
      ...
      While sw
        ...
        sdicISPEC_In.Item("FECHA_DMSA") = FECHA_DMSA
        sdicISPEC_In.Item("RUTFUN") = RUTFUN
        sdicISPEC_In.Item("VAMENU") = VAMENU
        objLINC_Conexion.Transmitir(sdicISPEC_In, sdicISPEC_Out, "WCADM", swError, strError)
        ...
        For i As Integer = 0 To cfSize '
          ...
          If (Not y = 0 And i = 0) Or ((sdicISPEC_Out("MREINT__AT_" & aux) = "" Or sdicISPEC_Out("MREINT__AT_" & aux) = "0") And (sdicISPEC_Out("DIASREI__AT_" & aux) = "" Or sdicISPEC_Out("DIASREI__AT_" & aux) = "0") And (sdicISPEC_Out("MARCA__AT_" & aux) = "" Or sdicISPEC_Out("MARCA__AT_" & aux) = "0") And (sdicISPEC_Out("NUMING__AT_" & aux) = "" Or sdicISPEC_Out("NUMING__AT_" & aux) = "0") And (sdicISPEC_Out("GLOINDDIA__AT_" & aux) = "" Or sdicISPEC_Out("GLOINDDIA__AT_" & aux) = "0") And (sdicISPEC_Out("SALDO_ADM__AT_" & aux) = "" Or sdicISPEC_Out("SALDO_ADM__AT_" & aux) = "0") And (sdicISPEC_Out("NRODIA_ADM__AT_" & aux) = "" Or sdicISPEC_Out("NRODIA_ADM__AT_" & aux) = "0") And (sdicISPEC_Out("FECHA_ADM__AT_" & aux) = "" Or sdicISPEC_Out("FECHA_ADM__AT_" & aux) = "0") And (sdicISPEC_Out("FECRES_ADM__AT_" & aux) = "" Or sdicISPEC_Out("FECRES_ADM__AT_" & aux) = "0") And (sdicISPEC_Out("NUMRES_ADM__AT_" & aux) = "" Or sdicISPEC_Out("NUMRES_ADM__AT_" & aux) = "0")) Then
            Continue For
          End If

          __dic.Add("MREINT", sdicISPEC_Out.Item("MREINT__AT_" & aux))
          __dic.Add("DIASREI", sdicISPEC_Out.Item("DIASREI__AT_" & aux))
          __dic.Add("MARCA", sdicISPEC_Out.Item("MARCA__AT_" & aux))
          __dic.Add("NUMING", sdicISPEC_Out.Item("NUMING__AT_" & aux))
          __dic.Add("GLOINDDIA", sdicISPEC_Out.Item("GLOINDDIA__AT_" & aux))
          __dic.Add("SALDO_ADM", sdicISPEC_Out.Item("SALDO_ADM__AT_" & aux))
          __dic.Add("NRODIA_ADM", sdicISPEC_Out.Item("NRODIA_ADM__AT_" & aux))
          __dic.Add("FECHA_ADM", sdicISPEC_Out.Item("FECHA_ADM__AT_" & aux))
          __dic.Add("FECRES_ADM", sdicISPEC_Out.Item("FECRES_ADM__AT_" & aux))
          __dic.Add("NUMRES_ADM", sdicISPEC_Out.Item("NUMRES_ADM__AT_" & aux))
          __cf("__COPYFROM__").Add(__dic)
        Next
        FECHA_DMSA = sdicISPEC_Out.Item("FECHA_DMSA")
      ...
      __dic = New Dictionary(Of String, String)
      __dic.Add("FECHA_DMSA", FECHA_DMSA)
  ...
  ''' <summary>
  ''' 15/07/2019 creacion:jcalderon
  ''' </summary>
  ''' <param name="ORQ"></param>
  ''' <param name="DIA_I"></param>
  ...
  ''' <remarks></remarks>
  <WebMethod()> _
  Public Function CCHAE(ByVal ORQ As String,
                                            ByVal DIA_I As String,
                                            ByVal PERIODO As String,
                                            ByVal RUTFUN As String) As String
    ...
    Try
      ...
      While sw
        ...
        sdicISPEC_In.Item("DIA_I") = DIA_I
        sdicISPEC_In.Item("PERIODO") = PERIODO
        sdicISPEC_In.Item("RUTFUN") = RUTFUN

        objLINC_Conexion.Transmitir(sdicISPEC_In, sdicISPEC_Out, "CCHAE", swError, strError)
        ...
        For i As Integer = 0 To cfSize '
          ...
          If (Not y = 0 And i = 0) Or (sdicISPEC_Out("DIAHORA__AT_" & aux) = "0") Then
            Continue For
          End If

          __dic.Add("MINATRAS", sdicISPEC_Out.Item("MINATRAS__AT_" & aux))
          __dic.Add("PUNTO_9", sdicISPEC_Out.Item("PUNTO_9__AT_" & aux))
          __dic.Add("HORATRAS", sdicISPEC_Out.Item("HORATRAS__AT_" & aux))
          __dic.Add("RMINUSAL", sdicISPEC_Out.Item("RMINUSAL__AT_" & aux))
          __dic.Add("PUNTO_8", sdicISPEC_Out.Item("PUNTO_8__AT_" & aux))
          __dic.Add("RHORASAL", sdicISPEC_Out.Item("RHORASAL__AT_" & aux))
          __dic.Add("RMINECOL", sdicISPEC_Out.Item("RMINECOL__AT_" & aux))
          __dic.Add("PUNTO_7", sdicISPEC_Out.Item("PUNTO_7__AT_" & aux))
          __dic.Add("RHORECOL", sdicISPEC_Out.Item("RHORECOL__AT_" & aux))
          __dic.Add("RMINSCOL", sdicISPEC_Out.Item("RMINSCOL__AT_" & aux))
          __dic.Add("PUNTO_6", sdicISPEC_Out.Item("PUNTO_6__AT_" & aux))
          __dic.Add("RHORSCOL", sdicISPEC_Out.Item("RHORSCOL__AT_" & aux))
          __dic.Add("RMINUENT", sdicISPEC_Out.Item("RMINUENT__AT_" & aux))
          __dic.Add("PUNTO_5", sdicISPEC_Out.Item("PUNTO_5__AT_" & aux))
          __dic.Add("RHORAENT", sdicISPEC_Out.Item("RHORAENT__AT_" & aux))
          __dic.Add("GLO_ASI", sdicISPEC_Out.Item("GLO_ASI__AT_" & aux))
          __dic.Add("EST_DIA", sdicISPEC_Out.Item("EST_DIA__AT_" & aux))
          __dic.Add("MINUSAL", sdicISPEC_Out.Item("MINUSAL__AT_" & aux))
          __dic.Add("PUNTO_4", sdicISPEC_Out.Item("PUNTO_4__AT_" & aux))
          __dic.Add("HORASAL", sdicISPEC_Out.Item("HORASAL__AT_" & aux))
          __dic.Add("MTOLENTC", sdicISPEC_Out.Item("MTOLENTC__AT_" & aux))
          __dic.Add("MINECOL", sdicISPEC_Out.Item("MINECOL__AT_" & aux))
          __dic.Add("PUNTO_3", sdicISPEC_Out.Item("PUNTO_3__AT_" & aux))
          __dic.Add("HORECOL", sdicISPEC_Out.Item("HORECOL__AT_" & aux))
          __dic.Add("MINSCOL", sdicISPEC_Out.Item("MINSCOL__AT_" & aux))
          __dic.Add("PUNTO_2", sdicISPEC_Out.Item("PUNTO_2__AT_" & aux))
          __dic.Add("HORSCOL", sdicISPEC_Out.Item("HORSCOL__AT_" & aux))
          __dic.Add("MTOLENT", sdicISPEC_Out.Item("MTOLENT__AT_" & aux))
          __dic.Add("HORAENT", sdicISPEC_Out.Item("HORAENT__AT_" & aux))
          __dic.Add("PUNTO_1", sdicISPEC_Out.Item("PUNTO_1__AT_" & aux))
          __dic.Add("MINUENT", sdicISPEC_Out.Item("MINUENT__AT_" & aux))
          __dic.Add("GLO_HOR", sdicISPEC_Out.Item("GLO_HOR__AT_" & aux))
          __dic.Add("DIAHORA", sdicISPEC_Out.Item("DIAHORA__AT_" & aux))
         
          __cf("__COPYFROM__").Add(__dic)
        Next

        DIA_I = sdicISPEC_Out.Item("DIA_I")
        PERIODO = sdicISPEC_Out.Item("PERIODO")
        RUTFUN = sdicISPEC_Out.Item("RUTFUN")


        If sdicISPEC_Out.Item("MENSAJE").ToString().ToUpper() = "HAY MAS DATOS" And ORQ = "T" Then
          sw = True
        Else
          sw = False
        End If
      ...
      __dic = New Dictionary(Of String, String)
      __dic.Add("DIA_I", DIA_I)
      __dic.Add("PERIODO", PERIODO)
      __dic.Add("RUTFUN", RUTFUN)


      __dic.Add("FECINI", sdicISPEC_Out.Item("FECINI"))
      __dic.Add("FECTER", sdicISPEC_Out.Item("FECTER"))
      __dic.Add("CAN_DI", sdicISPEC_Out.Item("CAN_DI"))
      __dic.Add("MIN_DI", sdicISPEC_Out.Item("MIN_DI"))
      __dic.Add("MIN_NO", sdicISPEC_Out.Item("MIN_NO"))
      __dic.Add("CAN_NO", sdicISPEC_Out.Item("CAN_NO"))
      __dic.Add("CAN_FE", sdicISPEC_Out.Item("CAN_FE"))
      __dic.Add("MIN_FE", sdicISPEC_Out.Item("MIN_FE"))
      __dic.Add("TOT_AUSEN", sdicISPEC_Out.Item("TOT_AUSEN"))
      __dic.Add("TOT_HOAT", sdicISPEC_Out.Item("TOT_HOAT"))
  ...
  ''' 12/07/2019 jcalderon: Se modifica el método para que funcione con mantenedor copyfrom.
  ''' </summary>
  ''' <param name="ORQ"></param>
