...
Namespace WS
    ...
    Partial Public Class WebService
        ...
        Private WCADMOperationCompleted As System.Threading.SendOrPostCallback
        
        Private CCHAEOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.lfprmbDll.My.MySettings.Default.lfprmbDll_WS_WebService
        ...
        '''<remarks/>
        Public Event WCADMCompleted As WCADMCompletedEventHandler
        
        '''<remarks/>
        Public Event CCHAECompleted As CCHAECompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/WCADM", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function WCADM(ByVal ORQ As String, ByVal FECHA_DMSA As String, ByVal RUTFUN As String, ByVal VAMENU As String) As String
            Dim results() As Object = Me.Invoke("WCADM", New Object() {ORQ, FECHA_DMSA, RUTFUN, VAMENU})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub WCADMAsync(ByVal ORQ As String, ByVal FECHA_DMSA As String, ByVal RUTFUN As String, ByVal VAMENU As String)
            Me.WCADMAsync(ORQ, FECHA_DMSA, RUTFUN, VAMENU, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub WCADMAsync(ByVal ORQ As String, ByVal FECHA_DMSA As String, ByVal RUTFUN As String, ByVal VAMENU As String, ByVal userState As Object)
            If (Me.WCADMOperationCompleted Is Nothing) Then
                Me.WCADMOperationCompleted = AddressOf Me.OnWCADMOperationCompleted
            End If
            Me.InvokeAsync("WCADM", New Object() {ORQ, FECHA_DMSA, RUTFUN, VAMENU}, Me.WCADMOperationCompleted, userState)
        End Sub
        
        Private Sub OnWCADMOperationCompleted(ByVal arg As Object)
            If (Not (Me.WCADMCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent WCADMCompleted(Me, New WCADMCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/CCHAE", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CCHAE(ByVal ORQ As String, ByVal DIA_I As String, ByVal PERIODO As String, ByVal RUTFUN As String) As String
            Dim results() As Object = Me.Invoke("CCHAE", New Object() {ORQ, DIA_I, PERIODO, RUTFUN})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub CCHAEAsync(ByVal ORQ As String, ByVal DIA_I As String, ByVal PERIODO As String, ByVal RUTFUN As String)
            Me.CCHAEAsync(ORQ, DIA_I, PERIODO, RUTFUN, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub CCHAEAsync(ByVal ORQ As String, ByVal DIA_I As String, ByVal PERIODO As String, ByVal RUTFUN As String, ByVal userState As Object)
            If (Me.CCHAEOperationCompleted Is Nothing) Then
                Me.CCHAEOperationCompleted = AddressOf Me.OnCCHAEOperationCompleted
            End If
            Me.InvokeAsync("CCHAE", New Object() {ORQ, DIA_I, PERIODO, RUTFUN}, Me.CCHAEOperationCompleted, userState)
        End Sub
        
        Private Sub OnCCHAEOperationCompleted(ByVal arg As Object)
            If (Not (Me.CCHAECompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent CCHAECompleted(Me, New CCHAECompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0")>  _
    Public Delegate Sub WCADMCompletedEventHandler(ByVal sender As Object, ByVal e As WCADMCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class WCADMCompletedEventArgs
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0")>  _
    Public Delegate Sub CCHAECompletedEventHandler(ByVal sender As Object, ByVal e As CCHAECompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class CCHAECompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
