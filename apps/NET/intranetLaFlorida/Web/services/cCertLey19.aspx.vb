...
''' </summary>
''' <remarks></remarks>
Partial Class cCertLey19
  Inherits System.Web.UI.Page

  Private __pagina As String = "../services/cCertLey19.aspx"
  ...
  Private __rutaFtp As String = ConfigurationManager.AppSettings("rutaFtpLey19")
    ...
    Try
      ...
      Select Case accion
        ...
        Case "Ley19"
          ...
          lblPara.Text = Request.Form("para")
          lblNombre.Text = reg.NOMBREFUN + " " + reg.APEPATFUN + " " + reg.APEMATFUN
          lblNombre2.Text = reg.NOMBREFUN + " " + reg.APEPATFUN + " " + reg.APEMATFUN
          ...
          Me.imgLogoBarrancas.Src = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "img/logolc.png")
          ...
          Dim NamePDF = "LF" & "901" & "002" & DateTime.Now.ToString("yyyyMM") + "00" & NCert
          ...
          Dim nombre As String = "L19" & actual & Right("00" & mes, 2) & 1 & Right("0000000000" & Trim(Session("Usuario.Rut")), 10) & ".pdf"
          ...
          With HttpContext.Current.Response
            ...
            .AddHeader("Content-Disposition", "inline; filename=ley19070.pdf")
            .BinaryWrite(buffer)
            .Flush()
            .Clear()
          End With
